...
class DemoWindow < Gosu::Window
  ...
  def draw
    ...
    draw_triangle(200, 150, Gosu::Color::BLUE, 300, 50, Gosu::Color::BLUE, 400, 150, Gosu::Color::BLUE, ZOrder::MIDDLE, mode=:default)
    #draw_line(200, 200, Gosu::Color::BLACK, 350, 350, Gosu::Color::BLACK, ZOrder::TOP, mode=:default)
    
    # draw_rect works a bit differently:
    Gosu.draw_rect(280, 150, 40, 150, Gosu::Color::YELLOW, ZOrder::TOP, mode=:default)
    ...
    img2.draw(50, 50, ZOrder::TOP, 1.0, 1.0, 0xff_ff0000)
